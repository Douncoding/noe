...
public class BabyListPagerAdapter extends PagerAdapter {
    private List<String> keySet;
    private List<Baby> dataSet;
    private OnSetupViewListener onSetupViewListener;

    public BabyListPagerAdapter(OnSetupViewListener onSetupViewListener) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        final View view = inflater.inflate(R.layout.list_item_baby, container, false);
        final BabyViewHolder holder = new BabyViewHolder(view);
     ...
     * 수행하면 된다.
     */
    public void add(String key, Baby baby) {
        keySet.add(key);
        dataSet.add(baby);
        notifyDataSetChanged();
    }

    public Baby getData(int position) {
        return dataSet.get(position);
    }

    public interface OnSetupViewListener {
        void onSetupView(BabyViewHolder holder, Baby baby, int position, String key);
    }
}
